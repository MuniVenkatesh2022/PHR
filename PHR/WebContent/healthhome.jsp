        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="healthhome.jsp" class="nav-link"><span data-hover="Home" style="color:  #ffffcc;"
   
                        >Home</span></a>
                        
                    </li>
                    <li class="nav-item">
                        <a href="adddoctors.jsp" class="nav-link"><span data-hover="Add Doctors" style="color: #ffffcc;">Add Doctors</span></a>
                    </li>
                    </li>
                    <li class="nav-item">
                        <a href="viewdoctors.jsp" class="nav-link"><span data-hover="View Doctors" style="color: #ffffcc;">View Doctors</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="hvpat.jsp" class="nav-link"><span data-hover="View Patients" style="color: #ffffcc;">View Patients</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="avreport.jsp" class="nav-link"><span data-hover="View Reports" style="color: #ffffcc;">View Reports</span></a>
                    </li>
                    <li class="nav-item">
