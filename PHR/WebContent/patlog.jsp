        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="keylog.jsp" class="nav-link"><span data-hover="Authority" style="color: blueviolet;">Authority</span></a>
                    </li>
                       <li class="nav-item">
                        <a href="proxy.jsp" class="nav-link"><span data-hover="Proxy" style="color: blueviolet;">Proxy</span></a>
                    </li>
                    <!-- <li class="nav-item">
...
<button type="submit" class="btn btn-primary">Login</button><!-- <input type="reset" value="reset"  style="color:white;background-color:#2e6da4 --><!-- "> -->
</br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<font style="verdana" color="black"> New register,click on </font><a href="patreg.jsp"><font style="color:red"><u>Register?</u></font></a>
</div>
    </form>
    </div>
    <br>
