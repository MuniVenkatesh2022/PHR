...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<tr><h3><font style="color:black"><b><u>View Appointments </u></b></font></h3><br>
...
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/PHR", "root",
		"root");
PreparedStatement ps=con.prepareStatement("select * from booking where demail='"+session.getAttribute("email")+"' and sts1='0'or sts1='1'  ");
