        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <h2 style="color:#ffffcc; text-align:center;"> A Lightweight Policy Update Scheme for Outsourced Personal Health Records Sharing </h2>
                </div>
                <!--/.navbar-header-->
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="pathome.jsp" class="nav-link"><span data-hover="Home" style="color:  #ffffcc;"
   
                        >Home</span></a>
                        
                    
                    <li class="nav-item">
                        <a href="viewprofile.jsp" class="nav-link"><span data-hover="View Profile" style="color: #ffffcc;">View profile</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="slot.jsp" class="nav-link"><span data-hover="View Reports" style="color: #ffffcc;">Slot Booking</span></a>
                    </li>
                   
                    <li class="nav-item">
                        <a href="pviewreports.jsp" class="nav-link"><span data-hover="View Reports" style="color: #ffffcc;">View Reports</span></a>
                    </li>
                    <li class="nav-item">
...
<div align="center">
<form action="bookback.jsp" style=" background-color:orange;
 width:300px; font-size= medium;">
<h3 style="font-weight: bold;color: blue;">Slot Booking</h3>
<table>


<tr>
<td>Doctor Name</td> <td><input type="text" name="dname" value="<%=request.getParameter("dn") %>" readonly=" readonly" required="required"></td></tr><tr>
<td>Doctor Mail</td><td><input type="email" name="dmail" value="<%=request.getParameter("email") %>"readonly="readonly" required="required"></td></tr><tr>
<td>Patient Name</td><td><input type="text" name="pname" value="<%=session.getAttribute("logname") %>" readonly="readonly" required="required"></td></tr><tr>
<td>Patient Email</td><td><input type="text" name="pmail"value="<%=session.getAttribute("email") %>" readonly="readonly" required="required"></td></tr><tr>
<td>Symptoms </td><td><input type="text" name="sympt"  required="required"></td></tr><tr>
<td>Date</td><td><input type="date" name="adate"   min="<%=dtf.format(now) %>" required="required"></td></tr><tr>
</table>
<input type="submit" class="sub" value="Book">
