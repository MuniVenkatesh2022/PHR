        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="proxyhome.jsp" class="nav-link"><span data-hover="Home" style="color:  #ffffcc;"
   
                        >Home</span></a>
                        
                  
                    <li class="nav-item">
                        <a href="patientreports.jsp" class="nav-link"><span data-hover="View Key Request" style="color: #ffffcc;">Send Patient Reports</span></a>
                    </li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<tr><h3><font style="color:black"><b><u> Send Patient Reports</u></b></font></h3><br>
...
PreparedStatement ps=con.prepareStatement("select * from booking where  request ='--' and sts1='2'");
