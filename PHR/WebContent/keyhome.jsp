        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="keyhome.jsp" class="nav-link"><span data-hover="Home" style="color:  #ffffcc;"
                   ...
                   <!--  </li>
                    ...
                    <li class="nav-item">
                        <a href="viewkeyrequest.jsp" class="nav-link"><span data-hover="View Key Request" style="color: #ffffcc;">View Key Requests</span></a>
                    </li>
                    <!-- <li class="nav-item">
