...
PreparedStatement pst =con.prepareStatement("select * from patreg where email='"+session.getAttribute("email")+"'");
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<tr><h3><font style="color:black"><b><u>View Profile </u></b></font></h3><br>
