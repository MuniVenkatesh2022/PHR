        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a href="slot.jsp" class="nav-link"><span data-hover="View Reports" style="color: blueviolet;">Slot Booking</span></a>
                   <!--  </li>
                    <li class="nav-item">
                        <a href="viewprofile.jsp" class="nav-link"><span data-hover="View Profile" style="color: blueviolet;">View profile</span></a>
                    </li> -->
...
<div align="center" style="margin-left: 20%;margin-right: 20%;margin-top: 10%;border-bottom-color: black; background-color:#ccc;" >
<h2>Schedules</h2>
...
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/PHR", "root",
		"root");
PreparedStatement ps=con.prepareStatement("select * from booking where pemail='"+session.getAttribute("email")+"'");
