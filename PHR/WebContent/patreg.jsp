        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="index.html" class="nav-link"><span data-hover="Home" style="color: blueviolet;"
   
                        >Home</span></a>
                        
                    </li>
                    <li class="nav-item">
                        <a href="healthcare.jsp" class="nav-link"><span data-hover="Health Care" style="color: blueviolet;"">Health Care</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="doctorlog.jsp" class="nav-link"><span data-hover="Doctor" style="color: blueviolet;">Doctor</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="patlog.jsp" class="nav-link"><span data-hover="Patient" style="color: blueviolet;">Patient</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="userlog.jsp" class="nav-link"><span data-hover="Authority" style="color: blueviolet;">Authority</span></a>
                    </li>
                    <!-- <li class="nav-item">
...
<div >
<center>
<form name="f1" action="patregback.jsp" method="POST" onsubmit="return validation()">
...
<div class="main-div">
    <div class="panel">
   <h5>Patient Registration Info</h5>
    ...
    <form id="Register">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="date" name="date" class="form-control" id="inputPassword" placeholder="Birth Date">

        </div>
         <div class="form-group">

            <input type="gender" name="gender" class="form-control" id="inputPassword" placeholder="Gender">

        </div>
         <div class="form-group">

            <input type="tel" name="phone" class="form-control" id="phone" placeholder="Mobile">

        </div>
         <div class="form-group">

            <input type="Address" name="address" class="form-control" id="inputPassword" placeholder="Address">
           </div>
           </div>
         <!-- <div class="form-group">

            <input type="Symptoms" name="symptoms" class="form-control" id="inputPassword" placeholder="Symptoms">
           </div> -->
