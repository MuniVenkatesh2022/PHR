...
<div align="center">
<form action="adddocback.jsp" style=" background-color:orange;
...
<tr><td>Number</td><td><input type="tel" name="a3" required="required"></td></tr>
...
<tr><td>Password</td><td><input type="password" name="pswd" required="required"></td></tr>
